...
public class CubeHull {
    ...
    public CubeHull(List<Measurement3D> measurements)
    {
    ...
    private void CalculateHull()
    {
        ...
        //float[] x = new float[]
        //{
        //    Measurements.Min(measurement => measurement.Position.x),
        //    Measurements.Max(measurement => measurement.Position.x)
        //};

        //float[] y = new float[]
        //{
        //    Measurements.Min(measurement => measurement.Position.y),
        //    Measurements.Max(measurement => measurement.Position.y)
        //};

        //float[] z = new float[]
        //{
        //    Measurements.Min(measurement => measurement.Position.z),
        //    Measurements.Max(measurement => measurement.Position.z)
        //};
